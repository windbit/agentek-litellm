...
STREAM_FIRST_CHUNK_RETRY_BASE_DELAY_SECONDS = float(
    os.getenv("STREAM_FIRST_CHUNK_RETRY_BASE_DELAY_SECONDS", 0.5)
)
STREAM_FIRST_CHUNK_RETRY_MAX_DELAY_SECONDS = float(
    os.getenv("STREAM_FIRST_CHUNK_RETRY_MAX_DELAY_SECONDS", 8)
)
