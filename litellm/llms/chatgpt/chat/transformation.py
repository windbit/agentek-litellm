...
class ChatGPTConfig(OpenAIConfig):
    ...
    def _get_openai_compatible_provider_info(
        ...
        # Provider discovery runs before per-deployment credentials are resolved,
        # so resolve only the API base here and defer token resolution to the
        # request hot-path. This avoids triggering a token refresh or interactive
        # device login during discovery.
