"""
Восстановление PII-токенов presidio в ответах /v1/responses.

Клиент (Hermes) собирает ход из событий стрима, а не из response.completed,
поэтому значения восстанавливаются в каждом событии, которое несёт текст или аргументы.
"""
...
class ResponsesStreamUnmasker:
    """
    Восстанавливает значения в событиях стрима Responses API.
